           ...
           <div class="row">
               <div class="col-xs-10 col-sm-10 col-md-8 col-sm-offset-1 col-md-offset-2">
                   <form:form role="form" commandName="userForm" action="${createWorker}" method="POST">
                       <h2>Time planner
                           <small><spring:message code="createWorker.createWorker"/></small>
                       </h2>
                       <hr class="colorgraph">
                       <div class="row">
                           ...
                           <div class="col-xs-12 col-sm-6 col-md-6">
                               <div class="form-group">
                                   ...
                                   <form:input path="lastName" type="text" name="lastName" id="lastName"
                                               cssClass="form-control input-lg" required="required"
                                               placeholder="${LN}" tabindex="2"/>
                               </div>
                           </div>
                       </div>
                       <div class="form-group">
                             <form:input path="email" type="email" name="email" id="email"
                                         cssClass="form-control input-lg" required="required" placeholder="Email"
                                         tabindex="3"/>
                       </div>
                       <div class="form-group">
                           <spring:message code="registration.phone" var="phone"/>
                           <form:input path="phone" type="text" name="phone" id="phone"
                                       cssClass="form-control input-lg" required="required" placeholder="${phone}"
                                       tabindex="4"/>
                       </div>
                       <div class="form-group">
                           <spring:message code="registration.phone" var="phone"/>
                               ...
                               <div class="form-group">
                                   <div class='input-group date' id='datetimepicker'>
                                           <form:input path="birthDate" type='date' pattern="yyyy/MM/dd"
                                                       max="2001-12-31" min="1950-01-02" cssClass="form-control"
                                                       id="birthDate"/>
                       ...
                       <div class="col-md-offset-2 col-xs-12 col-md-8">
                           ...
                           <div class="row">
                               <input type="submit" value="${registB}" class="btn btn-primary btn-block btn-lg"
                                      tabindex="7">
                           </div>
                       </div>
                   </form:form>
